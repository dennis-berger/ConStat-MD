#!/bin/bash
#SBATCH --job-name=codegen_gpu_llama8b  # Job name for Meta-Llama 8B model
...
python /storage/homefs/db18y058/ConStat-MD/main.py --model meta-llama/Meta-Llama-3.1-8B-Instruct
