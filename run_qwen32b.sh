#!/bin/bash
#SBATCH --job-name=codegen_gpu_qwen32b  # Job name for Qwen 32B model
#SBATCH --output=output_qwen32b.txt     # Output file
...
python /storage/homefs/db18y058/ConStat-MD/main.py --model Qwen/Qwen2.5-Coder-32B-Instruct
